...
if type_competition == 1:
    ...
    # 3. Make list of dictionaries that map line numbers to test feature matrices
    ...
    # 4. Make list of dictionaries that map line numbers to counters.
    line_counters = dict((key, 0) for key in os.listdir('./data_processing/bus-line-data-train'))

    # 5. Go over line numbers in master feature matrix and append appropriate prediction to results matrix.
